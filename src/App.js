...
import './App.css';
import Mobile from '../src/mobile.jpeg';
// import React, { useState } from "react";
import file from '../src/file.jpeg';
import file1 from '../src/file1.png';
import file2 from '../src/file2.jpeg';
  ...
  return (
    <>
      <div className="px-[60px]">
        <img className="h-[200px] w-full items-center " src={Mobile} alt='pic' />
        <form onSubmit={handleSubmit} class="max-w-md mx-auto">
          <h1 className="text-center pt-[20px] font-[700]">logo</h1>
          ...
          <div class="grid md:grid-cols-3  items-center pt-4 gap-3 md:gap-6">
            <div>
              ...
              <img src={file} alt='pic1' />
            </div>
            <div>
         
               <img  src={file1} alt='pic2'/>
            </div>
            <div>
             
               <img src={file2} alt='pic3' />
            </div>
          </div>
          <div class="grid md:grid-cols-3 pt-4 md:gap-6">
            <div class="flex items-start mb-5">
              <div class="flex items-center h-5">
                <input
                  id="terms"
